...
app.configure(function(){
    ...
    app.use(nobuc(/^\/(?:__u__|question|quiz|marking|io\/question|io\/test\/grade|io\/quiz|io\/email).*/, {
        hostname: GLOBAL.env === "production" ? "login.alibaba-inc.com" : "login-test.alibaba-inc.com",
        apphost: GLOBAL.hostname,
        appname: "tbuedquiz"
    }));

    app.use(user(/^\/(?:__u__|question|quiz|marking|io\/question|io\/test\/grade|io\/quiz|io\/email).*/));
